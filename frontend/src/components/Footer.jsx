...
function Footer() {
  return (
    <div className='bg-[#EEEAE6]'>
      <div className='flex px-52 pt-10 gap-16'>
        ...
        <p className='text-gray-500'>Quality <br /> Guaranteed</p>
        </div>
        <div className="flex gap-6 items-center">
      ...
      <div className="flex gap-10 mt-20 px-20 justify-between pb-20">
        <div className='w-[40%]'>
          <h2 className='text-2xl mb-4'>The man behind VB DACE</h2>
          <p className='text-sm mb-4'>The Celebrity Chef Venkatesh Bhat, is one of his kind and is revered by millions of home chefs, not just for his foolproof recipes, but also for all the small nuances and tricks he shares, that aid in recreating his recipes with the same magic.</p>
          <button>
        ...
        <div>
          ...
          <p className='text-sm'>Log In or Create an Account</p>
          <button className='mt-2 flex justify-between px-2 hover:bg-[#23272B] hover:text-white p-1 items-center w-[100%] border-[1px] border-black'>
            <p>Log In</p>
            <BiRightArrowAlt className='text-xl' />

          </button>
          <button className='mt-2 flex justify-between px-2 p-1 bg-[#23272B] text-white items-center w-[100%] border-[1px] border-black'>
      ...
      <div className=' border-b-[1px] border-gray-300 w-[90%] mx-20  '></div>
      <div className="mt-4 pb-14">
        <p className='text-sm px-20'>
        © 2023 VB Dace Appliances Private Limited. <br />
        All rights reserved.
        </p>
      </div>
