    ...
    <div>
        ...
        <div className='mx-16 text-base font-normal pt-16'>
          ...
          <div className='mt-3 pb-20'>
            <h1 className=' text-4xl'>Kitchenware</h1>
            ...
            {allProducts && allProducts.filter (product =>  product.category === 'kitchenware').map(product => (
              ...
              <div key={product._id} className='w-[280px] h-[320px]'>
                <div className='relative ' onMouseEnter={() => {setKitchenProduct(product._id)}} onMouseLeave={()=>{setKitchenProduct()}}>
                  <img src={kitchenProduct === product._id ? product.images[1] : product.images [0]} alt=""  className='w-full h-[300px]  object-cover bg-[#F5F5F5] p-4 '/>
