...
function Cart() {
  ...
  return (
    <div className='mx-16 mb-16'>
      ...
      <div className="flex">
        <div className='w-[72%]' >
          <div className='w-full flex  text-black font-semibold text-[15px] bg-[#EDEDED]  py-4'>
        ...
        <div className='mt-8 w-[28%] px-7'>
          <div className="flex justify-between text-gray-400 text-[16px] font-semibold">
          ...
          <button className='w-full rounded-md py-6 bg-[#C69E70] text-white font-semibold mt-5 shadow-xl'>Proceed to checkout</button>
