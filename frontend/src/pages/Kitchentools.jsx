  ...
  return (
    ...
    <div className='mx-16 text-base font-normal pt-16'>
      ...
      <div className='mt-3 pb-20'>
        <h1 className=' text-4xl'>Kitchen Tools</h1>
        <p className='mt-4'>Shop Kitchen Tools exclusively designed by Venkatesh <br />Bhat.</p>
      </div>
    </div>
    </div>
        ...
        {allProducts && allProducts.filter (product =>  product.category === 'kitchentools').map(product => (
          ...
          <div key={product._id} className='w-[280px] h-[320px]'>
            <div className='relative 'onMouseEnter={()=> setTools(product._id)} onMouseLeave={()=>setTools()}>
              <img src={tools === product._id ? product.images[1] : product.images[0]} alt=""  className='w-full h-[300px]  object-cover bg-[#F5F5F5] p-4 '/>
